...
func TestQuery(t *testing.T) {
	...
	"SELECT *, aa, bb as s, COUNT(*), count(*) as t, count(cc), count(cc) as u from test_table group by x having x > 6",
...
/*
		...
		str1 := Proto2SQL(pb)
		if strings.ToLower(str) != strings.ToLower(str1) {
			t.Errorf("%s", str)
			t.Errorf("%s", str1)
		}
*/
